...
import {
  ...
  SatelliteInfoBar,
  Trajectory,
  GroundStationNetworkCoverage,
} from "@cryptosat/cryptosim-visualization";
...
class MultiSatDemo extends React.Component {
  ...
  render() {
    ...
    let trajectory = this.state.displayTrajectory ? (
      <Trajectory satellite={sat} />
    ) : null;
    let coverage = this.state.displayCoverage ? (
      <GroundStationNetworkCoverage gsnetwork={this.gsnetwork} />
    ) : null;
    return (
...
function setupUniverse() {
  ...
  new Satellite(
    universe,
    "crypto8",
    COSMOS_482_DESCENT_CRAFT[0],
    COSMOS_482_DESCENT_CRAFT[1]
  );
  ...
  new Satellite(
    universe,
    "crypto62",
    IDEFIX_ARIANE_42P_R_B[0],
    IDEFIX_ARIANE_42P_R_B[1]
  );
  new Satellite(universe, "crypto63", AQUA[0], AQUA[1]);
  new Satellite(
    universe,
    "crypto64",
    MIDORI_II_ADEOS_II[0],
    MIDORI_II_ADEOS_II[1]
  );
  ...
  new Satellite(
    universe,
    "crypto78",
    CUSAT_2_FALCON_9_R_B[0],
    CUSAT_2_FALCON_9_R_B[1]
  );
